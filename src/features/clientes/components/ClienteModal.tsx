  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-zinc-600">
          <h2 className="text-lg sm:text-xl font-bold text-indigo-500">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          {/* Buttons */}
          <div className="flex flex-col-reverse sm:flex-row gap-3 sm:gap-4 pt-4 border-t border-zinc-600">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              type="submit"
              className="px-6 py-2.5 rounded-lg bg-indigo-500 text-zinc-100 font-semibold hover:bg-indigo-600 transition-colors touch-manipulation cursor-pointer w-full sm:w-auto"
            >
